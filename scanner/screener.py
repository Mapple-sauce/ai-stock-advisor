...
# ── 低位潜力模式权重 (基于120次回测优化, 正确率60%) ──
WEIGHTS_LOW = {
    "bb_position":    (0.156, "布林位置", "股价在布林带中的位置"),
    "daily_change":   (0.143, "当日涨幅", "当日涨跌幅范围, 窄幅企稳"),
    "ma_trend":       (0.138, "均线趋势", "多头/空头/缠绕, 核心趋势"),
    "macd_signal":    (0.125, "MACD信号", "金叉/死叉/柱线, 动量信号"),
    "ma5_stability":  (0.113, "MA5支撑", "价格在MA5位置, 短期企稳"),
    "rsi_position":   (0.081, "RSI位置", "超买超卖区间"),
    "kdj_signal":     (0.081, "KDJ信号", "金叉/死叉辅助"),
    "volume_ratio":   (0.059, "量价关系", "放量/缩量"),
    "near_high_low":  (0.052, "高低位置", "接近20日高/低点"),
    "price_position": (0.052, "价格位置", "相对MA20位置"),
}

# ── 追高跟强模式权重 (基于96次回测优化, 正确率55%) ──
WEIGHTS_MOMENTUM = {
    "ma_trend":       (0.153, "均线趋势", "多头排列为最核心信号"),
    "bb_position":    (0.136, "布林位置", "沿上轨运行=强势"),
    "kdj_signal":    (0.128, "KDJ信号", "KDJ高位钝化=强势持续"),
    "volume_ratio":   (0.117, "量价关系", "放量突破是追高核心"),
    "macd_signal":    (0.112, "MACD信号", "MACD多头+金叉做多"),
    "rsi_position":   (0.103, "RSI位置", "55-75最佳"),
    "daily_change":   (0.075, "当日涨幅", "3-7%最佳追高区间"),
    "ma5_stability":  (0.069, "MA5支撑", "短期支撑有效"),
    "price_position": (0.065, "价格位置", "在MA20上方"),
    "near_high_low":  (0.042, "高低位置", "接近20日高点=突破"),
}
